...
🔄 Task 6.3 (Progress Reporting) in progress - subtask 6.3.4c complete (on_shard_complete callback wired)
```
...
**Branch:** `feature/hf-hub-sink` (102 commits ahead of origin, local only)
...
| `hf_sink/mod.rs` | Wire `on_shard_complete` in upload_shard_task, `on_commit_*` in finalize | ✅ 6.3.4c / Pending 6.3.4d |
